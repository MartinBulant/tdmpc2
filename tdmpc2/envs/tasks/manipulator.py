...
_MANIPULATOR_XML_FILE_PATH = os.path.join(os.path.dirname(os.path.dirname(__file__)), 'tasks', 'manipulator.xml')



def make_model(use_peg, insert):
  """Returns a tuple containing the model XML string and a dict of assets."""
  xml_string = common.read_model(_MANIPULATOR_XML_FILE_PATH)
...
def bring_peg_custom(fully_observable=True, time_limit=_TIME_LIMIT, random=None,
...
class Bring(base.Task):
  ...
  def _peg_reward(self, physics):
    ...
    return self._is_close(physics.site_distance('peg', 'target_peg'))
